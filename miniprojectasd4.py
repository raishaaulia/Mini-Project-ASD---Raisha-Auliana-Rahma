...
class PengirimanData:
    ...
    def jump_search_kode(self, kode_pengiriman):
        current_node = self.head
        while current_node is not None and current_node.data.kode_pengiriman != kode_pengiriman:
            current_node = current_node.next
        return current_node

    def jump_search_nama(self, nama_pengirim):
        current_node = self.head
        while current_node is not None and current_node.data.nama_pengirim != nama_pengirim:
            current_node = current_node.next
        return current_node
    ...
    def tampilkan_pencarian(self):
        ...
        print("=======================================")
        print("1. Searching Berdasarkan Kode Pengiriman")
        print("2. Searching Berdasarkan Nama Pengirim")
        pilihan_searching = input("Masukkan pilihan pencarian (1/2): ")

        if pilihan_searching == '1':
            kode_pengiriman = input("Masukkan kode pengiriman yang akan dicari: ")
            found_node = self.jump_search_kode(kode_pengiriman)
            if found_node:
                print("\nPaket dengan kode", kode_pengiriman, "ditemukan:")
                print("Kode Pengiriman:", found_node.data.kode_pengiriman)
                print("Nama Pengirim:", found_node.data.nama_pengirim)
                print("Alamat Pengirim:", found_node.data.alamat_pengirim)
                print("Nama Penerima:", found_node.data.nama_penerima)
                print("Alamat Penerima:", found_node.data.alamat_penerima)
                print("Detail Barang:", found_node.data.detail_barang)
                print("Jasa Pengirim:", found_node.data.jasa_pengirim)
                print("Biaya Pengiriman:", found_node.data.biaya_pengiriman)
            else:
                print("\nPaket dengan kode", kode_pengiriman, "tidak ditemukan.")
        elif pilihan_searching == '2':
            nama_pengirim = input("Masukkan nama pengirim yang akan dicari: ")
            found_node = self.jump_search_nama(nama_pengirim)
            if found_node:
                print("\nPaket dengan nama pengirim", nama_pengirim, "ditemukan:")
                print("Kode Pengiriman:", found_node.data.kode_pengiriman)
                print("Nama Pengirim:", found_node.data.nama_pengirim)
                print("Alamat Pengirim:", found_node.data.alamat_pengirim)
                print("Nama Penerima:", found_node.data.nama_penerima)
                ...
                print("\nPaket dengan nama pengirim", nama_pengirim, "tidak ditemukan.")
        else:
...
def main():
    ...
    while True:
        ...
        if pilihan == '1':
            ...
            data.tampilkan_pencarian()
            
        elif pilihan == '7':
                print("\nTerima kasih telah menggunakan sistem pengiriman paket!")
                break
